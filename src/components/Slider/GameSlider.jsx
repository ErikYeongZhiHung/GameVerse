          ...
          <div className="relative flex-1 flex flex-col justify-end rounded-2xl h-[450px] min-w-[480px] max-w-full overflow-hidden">
            ...
            <div className="relative z-20 p-6 space-y-3 flex flex-col justify-end h-full">
              ...
              <div className="flex gap-2 flex-wrap">
                <button className="bg-white text-black px-5 py-2 rounded-lg text-sm font-semibold hover:bg-gray-200 shadow">
                  Buy Now
                </button>
                <button className="border border-white text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-white hover:text-black transition shadow">
                  + Add to Wishlist
                </button>
              </div>
            </div>
